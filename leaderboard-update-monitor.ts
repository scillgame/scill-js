import {LeaderboardUpdatePayload} from "./api";
import {getAuthApi, SCILLEnvironment} from "./scillclient";

import * as mqtt from "mqtt";

export class LeaderboardUpdateMonitor {
  mqttClient: mqtt.MqttClient;
  public accessToken: string;

  constructor(accessToken: string, leaderboardId: string, handler: (payload: LeaderboardUpdatePayload) => void, environment?: SCILLEnvironment) {
